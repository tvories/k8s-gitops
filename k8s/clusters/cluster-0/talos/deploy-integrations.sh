...
rm -rf cni/charts
envsubst < ../../../../k8s/clusters/cluster-0/manifests/kube-system/cilium/values.yaml > cni/values.yaml
kustomize build --enable-helm cni | kubectl apply -f -
rm cni/values.yaml
rm -rf cni/charts

rm -rf kubelet-csr-approver/charts
envsubst < ../../../../k8s/clusters/cluster-0/manifests/system-controllers/kubelet-csr-approver/values.yaml > kubelet-csr-approver/values.yaml
